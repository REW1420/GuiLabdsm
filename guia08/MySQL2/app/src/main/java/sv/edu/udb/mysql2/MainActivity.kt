...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val et1=findViewById<EditText>(R.id.txtCodigo)
        val et2=findViewById<EditText>(R.id.txtDescripcion)
        val et3=findViewById<EditText>(R.id.txtPrecio)
        ...
        boton5.setOnClickListener {
            ...
            val cant = bd.update("articulos", registro, "codigo=${et1.text.toString()}",
                null)
            bd.close()
            if (cant == 1)
